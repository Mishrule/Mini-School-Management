                                ...
                                <form method="POST" action="signup.php">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="contact" class="form-control" id="contact" placeholder="0245181940" required />
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div align="center">
                                            <button type="submit" id="send" name="send" value="send" style="margin:10px; border-radius:45%; font-weight:bold;" class="btn btn-primary btn-lg">
                                                Submit
                                            </button>
                                        </div>
                                    </div>
